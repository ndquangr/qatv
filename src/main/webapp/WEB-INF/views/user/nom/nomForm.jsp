	...
	<script>
		...
		function addRow(obj) {
			...
			$f = '<tr valign="top">'
				...
				+	'<td class="text-center"><input class="form-control" type="text" name="SUB.CHAR_VIET" value=""/></td>'
			        ...
			        <c:choose>
			        	<c:when test="${!empty SUB}">
			        		<c:forEach items="${SUB}" var="item" varStatus="state">
			        			<tr valign="top">
									...
									<td class="text-center"><input class="form-control" type="text" name="SUB.CHAR_VIET" value="${item.CHAR_VIET }"/></td>
			        	...
			        	<c:otherwise>
			        		<tr valign="top">
								...
								<td class="text-center"><input class="form-control" type="text" name="SUB.CHAR_VIET" value=""/></td>
								<td class="text-center">
								<textarea class="form-control" rows="3" name="SUB.CHAR_DEF" >${CHAR_DEF }</textarea>
