    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/resources/smarteditor/photo_uploader/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			sUrl  : '/resources/smarteditor/photo_uploader/file_uploader.jsp',   //변경 URL입니다.
	 ...
	 */
 	...
 	jindo.$Ajax.prototype.request = function(oData) {
 		...
 		if (opt.sendheader) {
			...
			req.setRequestHeader('X-CSRF-Token', document.getElementById("csrf_token").value);
		}
