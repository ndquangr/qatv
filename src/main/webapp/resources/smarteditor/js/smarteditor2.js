	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				var linkNode2 = doc.createElement('link');
				linkNode2.type = 'text/css';
				linkNode2.rel = 'stylesheet';
				linkNode2.href = '/resources/css/sejong/default.css';
				headNode.appendChild(linkNode2);

				var scriptNode = doc.createElement('script');
				scriptNode.type = 'text/javascript';
				scriptNode.src = '/resources/js/sejong/jquery-1.11.0.min.js';
				headNode.appendChild(scriptNode);

				var scriptNode2 = doc.createElement('script');
				scriptNode2.type = 'text/javascript';
				scriptNode2.src = '/resources/js/sejong/common.js';
